...
exports.stopPullDownRefresh = function (call) {
    wx.stopPullDownRefresh(call);
};
exports.startPullDownRefresh = function (call) {
    wx.startPullDownRefresh(call);
};
...
exports.withShareTicket = function (data) {
    return new Promise(function (resolve, reject) {
        wx.withShareTicket({
...
exports.getAccountInfoSync = function (data) {
    wx.getAccountInfoSync(data);
};
...
var onBeaconUpdate = function (call) {
    wx.onBeaconUpdate(call);
};
var onBeaconServiceChange = function (call) {
...
var onWifiConnected = function (call) {
    wx.onWifiConnected(call);
};
var onGetWifiList = function (call) {
