...
export declare const Prop_Analysis: (options: any, params: any) => any;
...
export declare const Watch_Analysis: (options: any, params: any) => void;
export declare const Filter: (name: string) => any;
export declare const ImgToBase64: (src: string) => any;
export declare const ImgToBase64_Analysis: (options: any, params: any) => any;
export default tenp;
