...
export declare const getSystemInfoSync: () => wx.SystemInfo;
/**获取系统信息 */
export declare const getSystemInfo: () => Promise<wx.SystemInfo>;
/**
 ...
 * @version 1.9.90
 */
export declare const getUpdateManager: () => wx.UpdateManager;
/**
 ...
 * @version 2.1.2
 */
export declare const getLaunchOptionsSync: (call: (params: wx.AppOptions) => void) => void;
/**
 * 监听小程序要打开的页面不存在事件
 *
 * @version 2.1.2
 ...
 * @version 0.0.0
 */
export declare const request: (optios: wx.RequestOptions) => Promise<{}>;
/**
...
/**异步获取当前storage的相关信息 */
export declare const getStorageInfo: () => Promise<wx.StorageInfo>;
/**wx.getStorageInfo 的同步版本 */
export declare const getStorageInfoSync: () => wx.StorageInfo;
/**
 * 创建 map 上下文 [MapContext](https://developers.weixin.qq.com/miniprogram/dev/api/media/map/MapContext.html) 对象。
 */
export declare const createMapContext: (mapId: string) => wx.MapContext;
/**
 * 保存图片到系统相册
 *
 ...
 *
 */
export declare const createVideoContext: (videoId: string) => wx.VideoContext;
/**
 * 拍摄视频或从手机相册中选视频
 *
 */
 ...
 * @version 1.6.0
 */
export declare const createInnerAudioContext: () => wx.InnerAudioContext;
/**
 * 创建 audio 上下文 [AudioContext](https://developers.weixin.qq.com/miniprogram/dev/api/media/audio/AudioContext.html) 对象
 *
 * 从基础库 1.6.0 开始，本接口停止维护，请使用 [wx.createInnerAudioContext](https://developers.weixin.qq.com/miniprogram/dev/api/media/audio/wx.createInnerAudioContext.html) 代替
 */
export declare const createAudioContext: (id: string, instance: any) => wx.AudioContext;
/**
 * 停止播放音乐
 *
 ...
 * @version 1.2.0
 */
export declare const getBackgroundAudioManager: () => wx.BackgroundAudioManager;
...
export declare const createLivePlayerContext: (id: string, instance?: any) => wx.LivePlayerContext;
/**
 * 停止录音
 *
 ...
 * @version 1.6.0
 */
export declare const getRecorderManager: () => wx.RecorderManager;
/**
 * 创建 camera 上下文 [CameraContext](https://developers.weixin.qq.com/miniprogram/dev/api/media/camera/CameraContext.html) 对象
 *
 * @version 1.6.0
 */
export declare const createCameraContext: () => wx.CameraContext;
/**
 * 使用微信内置地图查看位置
 *
 */
 ...
 *
 */
export declare const getSavedFileList: () => Promise<wx.GetSavedFileListData>;
/**
 ...
 * @version 1.9.9
 */
export declare const getFileSystemManager: () => wx.FileSystemManager;
/**
 * 获取文件信息
 *
 * @version 1.4.0
 ...
 * @version 1.2.0
 */
export declare const onBeaconUpdate: (call?: (beacons: wx.Beacon[]) => void) => void;
/**
 * 监听 iBeacon 服务状态变化事件
 *
 * @version 1.2.0
 ...
 *
 */
export declare const getBeacons: () => Promise<wx.GetBeaconsSuccess>;
/**
 * 关闭 Wi-Fi 模块
 *
 * @version 1.6.0
 ...
 * @version 1.6.0
 */
export declare const onWifiConnected: (callback?: (wifi: wx.WiFi) => void) => void;
/**
 * 监听获取到 Wi-Fi 列表数据事件
 *
 * @version 1.6.0
 */
export declare const onGetWifiList: (callback?: (res: wx.GetWifiListOptions) => void) => void;
/**
 ...
 * @version 1.6.0
 */
export declare const getConnectedWifi: () => Promise<wx.WiFi>;
/**
...
/**监听蓝牙适配器状态变化事件 */
export declare const onBluetoothAdapterStateChange: (callback?: (res: wx.BluetoothAdapterState) => void) => void;
/**
 ...
 *
 */
export declare const getBluetoothAdapterState: () => Promise<wx.BluetoothAdapterStateData>;
/**
 ...
 *
 */
export declare const getNetworkType: () => Promise<wx.NetworkTypeData>;
/**
 * 设置屏幕亮度
 *
 * @version 1.2.0
 ...
 */
export declare const onAccelerometerChange: (callback: wx.AccelerometerChangeCallback) => void;
/**
 * 停止监听罗盘数据
 *
 */
...
export declare const onCompassChange: (callback: wx.CompassChangeCallback) => void;
/**
 * 停止监听设备方向的变化
 *
 * @version 2.3.0
...
export declare const getExtConfigSync: () => wx.ExtConfig;
/**
 * 获取第三方平台自定义的数据字段
 *
 */
export declare const getExtConfig: () => Promise<wx.ExtConfig>;
/**
 ...
 * @version 1.9.3
 */
export declare const createIntersectionObserver: (context: wx.Component<any, any, []>, options?: wx.CreateIntersectionObserverOption) => wx.IntersectionObserver;
/**
