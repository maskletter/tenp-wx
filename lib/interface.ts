...
namespace tenp{
	...
	export let showTabBarRedDot:(params: { index: number }) => Promise<any>;
	/**显示 tabBar */
	export let showTabBar:(params?: { animation?: boolean }) => Promise<any>;
	/**动态设置 tabBar 的整体样式 */
	export let setTabBarStyle:(params: { 
		color: string 
		selectedColor: string
		backgroundColor: string
		borderStyle: string
	...
	export let setTabBarItem:(params: {
		index: number
		text?: string
		iconPath?: string
	...
	export let setTabBarBadge:(params: {
		index: number
		text: string
	}) => Promise<any>;
	/**移除 tabBar 某一项右上角的文本 */
	export let removeTabBarBadge:(params: { index: number }) => Promise<any>;
	/**隐藏 tabBar 某一项的右上角的红点 */
	export let hideTabBarRedDot:(params: { index: number }) => Promise<any>;
	/**隐藏 tabBar */
	export let hideTabBar:(params?: { animation: boolean }) => Promise<any>;
	/**
	 ...
	 */
	export let loadFontFace:(params: { 
		family: string 
		source: string
		desc?: {
	...
	/**停止当前页面下拉刷新 */
	export let stopPullDownRefresh:() => Promise<any>;
	/**开始下拉刷新。调用后触发下拉刷新动画，效果与用户手动下拉刷新一致 */
	export let startPullDownRefresh:() => Promise<any>;
	/**将页面滚动到目标位置 */
	export let pageScrollTo:(params: {
		scrollTop: number
		duration?: number
	}) => Promise<any>
	...
	export let createAnimation:(params?: {
		duration?: number
	...
	export let setTopBarText:(params: { text: string }) => Promise<any>
	/**延迟一部分操作到下一个时间片再执行。（类似于 setTimeout） */
	export let nextTick:(call: Function) => void;
	/**监听窗口尺寸变化事件 */
	export let onWindowResize:(call: Function) => void;
	/**取消监听窗口尺寸变化事件 */
	export let offWindowResize:(call: Function) => void;
	/**[wx.setStorage](https://developers.weixin.qq.com/miniprogram/dev/api/storage/wx.setStorage.html) 的同步版本 */
	export let setStorageSync:(key: string, data: any) => void;
	/**[wx.getStorage](https://developers.weixin.qq.com/miniprogram/dev/api/storage/wx.getStorage.html) 的同步版本 */
	export let getStorageSync:(call: Function) => void;
	/**从本地缓存中移除指定 key */
	export let removeStorage:(params: { key: string }) => void;
	/**[wx.clearStorage](https://developers.weixin.qq.com/miniprogram/dev/api/storage/wx.clearStorage.html) 的同步版本 */
	export let clearStorageSync:(call: Function) => void;
	/**将数据存储在本地缓存中指定的 key 中。会覆盖掉原来该 key 对应的内容。数据存储生命周期跟小程序本身一致，即除用户主动删除或超过一定时间被自动清理，否则数据都一直可用。单个 key 允许存储的最大数据长度为 1MB，所有数据存储上限为 10MB */
	export let setStorage:(params: { key: string, data: any }) => void;
	/**[wx.removeStorage](https://developers.weixin.qq.com/miniprogram/dev/api/storage/wx.removeStorage.html) 的同步版本 */
	export let removeStorageSync:(key: string) => void;
	/**从本地缓存中异步获取指定 key 的内容 */
	export let getStorage:(params: { key: string }) => any
	/**清理本地数据缓存 */
	export let clearStorage:() => void;
	/**保存图片到系统相册 */
	export let saveImageToPhotosAlbum:(params: { filePath: string }) => Promise<any>
	/**在新页面中全屏预览图片。预览的过程中用户可以进行保存图片、发送给朋友等操作 */
	export let previewImage:(params: { urls: string[], current?: string }) => Promise<any>
	/**获取图片信息。网络图片需先配置download域名才能生效 */
	export let getImageInfo:(params: { src: string }) => Promise<any>
	/**压缩图片接口，可选压缩质量 */
	export let compressImage:(params: { src: string, quality?: number }) => Promise<any>
	/**从客户端会话选择文件 */
	export let chooseMessageFile:(params: { count: number, type: 'all'|'video'|'image'|'file' }) => Promise<{ tempFiles: {path: string, size: number, name: string, type: string, time: number}[] }>
	/**从本地相册选择图片或使用相机拍照 */
	export let chooseImage:(params: { count: number, sizeType: string[], sourceType: string[] }) => Promise<any>
	/**保存视频到系统相册。支持mp4视频格式 */
	export let saveVideoToPhotosAlbum:(params: { filePath: string }) => Promise<any>
	/**拍摄视频或从手机相册中选视频 */
	export let chooseVideo:(params: { sourceType?: string[], compressed?: boolean, maxDuration: number, camera: 'back'|'front' }) => Promise<any>
	/**结束播放语音 */
	export let stopVoice:() => Promise<any>
	...
	export let setInnerAudioOption:(params: { mixWithOther?: boolean, obeyMuteSwitch?: boolean }) => Promise<any>
	/**开始播放语音。同时只允许一个语音文件正在播放，如果前一个语音文件还没播放完，将中断前一个语音播放 */
	export let playVoice:(params: { filePath: string, duration?: number }) => Promise<any>
	...
	export let pauseVoice:() => Promise<any>
	/**获取当前支持的音频输入源 */
	export let getAvailableAudioSources:() => Promise<any>
	/**停止播放音乐 */
	export let stopBackgroundAudio:() => Promise<any>
	/**控制音乐播放进度 */
	export let seekBackgroundAudio:(params: { position: number }) => Promise<any>
	/**
	 * 使用后台播放器播放音乐。
	 * 
	 * 对于微信客户端来说，只能同时有一个后台音乐在播放。当用户离开小程序后，音乐将暂停播放；当用户在其他小程序占用了音乐播放器，原有小程序内的音乐将停止播放 */
	export let playBackgroundAudio:(params: { dataUrl: string, title?: string, coverImgUrl?: string }) => Promise<any>
	/**监听音乐停止事件 */
	export let onBackgroundAudioStop:(call: Function) => Promise<any>
	/**监听音乐播放事件 */
	export let onBackgroundAudioPlay:(call: Function) => Promise<any>
	/**监听音乐暂停事件 */
	export let onBackgroundAudioPause:(call: Function) => Promise<any>
	/**获取后台音乐播放状态 */
	export let getBackgroundAudioPlayerState:() => Promise<{duration:number,currentPosition:number,status:number,downloadPercent:number,dataUrl:string}>
	/**
	 * 获取全局唯一的背景音频管理器。 
	 * 
	 ...
	 */
	export let getBackgroundAudioManager:() => wx.BackgroundAudioManager;
	/**获取全局唯一的录音管理器 RecorderManager */
	export let getRecorderManager:() => wx.RecorderManager
	/**创建 camera 上下文 CameraContext 对象 */
	export let createCameraContext:() => wx.CameraContext
	/**使用微信内置地图查看位置 */
	export let openLocation:(params: { latitude: number, longitude: number, scale?: number, name?: string, address?: string }) => Promise<any>
	/**获取当前的地理位置、速度。当用户离开小程序后，此接口无法调用 */
	export let getLocation:(params: { type?: 'wgs84'|'gcj02', altitude?: number }) => Promise<{
		latitude: number
		longitude: number
		speed: number
		accuracy: number
	...
	/**打开地图选择位置 */
	export let chooseLocation:() => Promise<{
		name: string
		address: string
		latitude: string
		longitude: string
	...
	/**更新转发属性 */
	export let updateShareMenu:(params?: { 
	...
	/**显示当前页面的转发按钮 */
	export let showShareMenu:(params?: { withShareTicket?: number }) => Promise<{
		errMsg: string
	...
	/**隐藏转发按钮 */
	export let hideShareMenu:() => Promise<any>
	/**获取转发详细信息 */
	export let getShareInfo:(params: { shareTicket: string, timeout?: number }) => Promise<any>
	/**保存文件到本地。注意：saveFile 会把临时文件移动，因此调用成功后传入的 tempFilePath 将不可用 */
	export let saveFile:(params: { tempFilePath: string }) => Promise<any>
	/**删除本地缓存文件 */
	export let removeSavedFile:(params: { filePath: string }) => Promise<any>
	/**新开页面打开文档 */
	export let openDocument:(params: { filePath: string, fileType?: 'doc'|'docx'|'xls'|'xlsx'|'ppt'|'pptx'|'pdf' }) => Promise<any>
	/**获取该小程序下已保存的本地缓存文件列表 */
	export let getSavedFileList:() => Promise<{
		fileList: {
			filePath: string
			size: number
			createTime: number
	...
	export let getSavedFileInfo:(params: { filePath: string }) => Promise<{
		size: number
		createTime: number
	}>
	/**获取全局唯一的文件管理器 */
	export let getFileSystemManager:() => wx.FileSystemManager
	/**获取文件信息 */
	export let getFileInfo:(params: { filePath: string, digestAlgorithm?: 'md5'|'sha1' }) => Promise<{
		size: number
		digest: string
	}>
	/**调用接口获取登录凭证（code）。
	...
	export let login:(params?: { timeout?: number }) => Promise<{
		code: string
	}>
	/**
	 * 检查登录态是否过期
	 ...
	 */
	export let checkSession:() => Promise<any>
	/**打开另一个小程序 
	 * @version 1.3.0
	*/
	export let navigateToMiniProgram:(params: { 
		appId: string
		path?: string
		extraData?: any
	 ...
	 * @version 1.3.0
	*/
	export let navigateBackMiniProgram:(params?: { extraData?: any }) => Promise<any>
	/**获取当前帐号信息 */
	export let getAccountInfoSync:() => Promise<any>
	...
	/**获取用户信息 */
	export let getUserInfo:(params?: { withCredentials?: boolean, lang?: 'en'|'zh_CN'|'zh_TW' }) => Promise<{
		userInfo: UserInfo
		rawData: string
		signature: string
		encryptedData: string
	...
	export let requestPayment:(params: {
		timeStamp: string
		nonceStr: string
		package: string
	 ...
	 * @version 1.1.0
	 * */
	export let openSetting:() => Promise<{
	 ...
	 * @version 1.1.0
	 */
	export let chooseAddress:(params: { position: number }) => Promise<{
		userName: string
		postalCode: string
		provinceName: string
		cityName: string
	 ...
	 * @version 1.5.0
	 */
	export let chooseInvoiceTitle:() => Promise<{
		/**0:单位,1:个人 */
		type: 0|1
		title: string
		taxNumber: string
	 ...
	 * @version 1.5.0
	 */
	export let checkIsSupportSoterAuthentication:() => Promise<{
	 ...
	 * @version 1.6.0
	 */
	export let checkIsSoterEnrolledInDevice:(params: { checkAuthMode: 'fingerPrint'|'facial'|'speech' }) => Promise<{
		isEnrolled: boolean
		errMsg: string
	}>
	/**
	 ...
	 * @version 1.2.0
	 */
	export let getWeRunData:() => Promise<{
		encryptedData: string
		iv: string
		cloudID: string
	}>
	 ...
	 * @version 1.2.0
	 */
	export let stopBeaconDiscovery:() => Promise<any>
	/**
	 * 开始搜索附近的 iBeacon 设备
	 * @version 1.2.0
	 */
	export let startBeaconDiscovery:(params: { uuids: string[], ignoreBluetoothAvailable?: boolean }) => Promise<any>
	 ...
	 * @version 1.2.0
	 */
	export let onBeaconUpdate:(call: (res: IBeaconInfo) => void) => void;
	/**
	 * 监听 iBeacon 服务状态变化事件
	 * @version 1.2.0
	 */
	export let onBeaconServiceChange:(call: (res: { available: boolean, discovering: boolean }) => void) => void
	/**
	 * 获取所有已搜索到的 iBeacon 设备
	 * @version 1.2.0
	 */
	export let getBeacons:() => Promise<{
		beacons: IBeaconInfo[]
	}>
	/**
	 * 关闭 Wi-Fi 模块
	 * @version 1.6.0
	 */
	export let stopWifi:() => Promise<any>
	/**
	 * 初始化 Wi-Fi 模块
	 * @version 1.6.0
	 */
	export let startWifi:() => Promise<any>
	/**
	 * 设置 wifiList 中 AP 的相关信息。在 onGetWifiList 回调后调用，iOS特有接口
	 * @version 1.6.0
	 */
	export let setWifiList:(params: { wifiList: string[] }) => Promise<any>
	 ...
	 * @version 1.6.0
	 */
	export let onWifiConnected:(call: (wifi: WifiInfo) => void) => void
	/**
	 * 监听获取到 Wi-Fi 列表数据事件
	 * @version 1.6.0
	 */
	export let onGetWifiList:(call: (wifiList: WifiInfo[]) => void) => void
	/**
	 ...
	 * @version 1.6.0
	 */
	export let getWifiList:() => Promise<any>
	/**
	 * 获取已连接中的 Wi-Fi 信息
	 * @version 1.6.0
	 */
	export let getConnectedWifi:(params: { position: number }) => Promise<{
		wifi: WifiInfo
	}>
	/**
	 ...
	 * @version 1.6.0
	 */
	export let connectWifi:(params: { SSID: string, BSSID?: string, password: string }) => Promise<any>
	/**
	 * 读取低功耗蓝牙设备的特征值的二进制数据值。注意：必须设备的特征值支持 read 才可以成功调用
	 * @version 1.1.0
	 */
	export let readBLECharacteristicValue:(params: { deviceId: string, serviceId: string, characteristicId: string }) => Promise<any>
	/**
	 * 监听低功耗蓝牙连接状态的改变事件。包括开发者主动连接或断开连接，设备丢失，连接异常断开等等
	 * @version 1.1.0
	 */
	export let onBLEConnectionStateChange:(call: (result: { deviceId: string, connected: boolean }) => void) => void
	/**
	 * 监听低功耗蓝牙设备的特征值变化事件。必须先启用 notifyBLECharacteristicValueChange 接口才能接收到设备推送的 notification
	 * @version 1.1.0
	 */
	export let onBLECharacteristicValueChange:(call: (result: { deviceId: string, serviceId: string, characteristicId: string, value: ArrayBuffer }) => void) => void
	/**
	 ...
	 * @version 1.1.0
	 */
	export let notifyBLECharacteristicValueChange:(params: { deviceId: string, serviceId: string, characteristicId: string, state: string }) => Promise<any>
	/**
	 * 获取蓝牙设备所有服务(service)
	 * @version 1.1.0
	 */
	export let getBLEDeviceServices:(params: { deviceId: string }) => Promise<{
	 ...
	 * @version 1.1.0
	 */
	export let getBLEDeviceCharacteristics:(params: { deviceId: string, serviceId: string }) => Promise<any>
	/**
	 * 连接低功耗蓝牙设备
	 * 
	 ...
	 * @version 1.1.0
	 */
	export let createBLEConnection:(params: { deviceId: string, timeout?: number }) => Promise<any>
	/**
	 * 断开与低功耗蓝牙设备的连接
	 * @version 1.1.0
	 */
	export let closeBLEConnection:(params: { deviceId: string }) => Promise<any>
	/**
	 * 向低功耗蓝牙设备特征值中写入二进制数据。注意：必须设备的特征值支持 write 才可以成功调用
	 * @version 1.1.0
	 */
	export let writeBLECharacteristicValue:(params: { deviceId: string, serviceId: string, characteristicId: string, value: ArrayBuffer }) => Promise<any>
	/**
	 * 添加手机通讯录联系人。用户可以选择将该表单以「新增联系人」或「添加到已有联系人」的方式，写入手机系统通讯录
	 * @version 1.2.0
	 */
	export let addPhoneContact:(params: {
		firstName: string
	 ...
	 * @version 1.1.0
	 */
	export let stopBluetoothDevicesDiscovery:() => Promise<any>
	/**
	 ...
	 * @version 1.1.0
	 */
	export let startBluetoothDevicesDiscovery:(params: {
		services?: string[]
	 ...
	 * @version 1.1.0
	 */
	export let openBluetoothAdapter:() => Promise<any>
	/**
	 * 监听寻找到新设备的事件
	 * @version 1.1.0
	 */
	export let onBluetoothDeviceFound:(call: (res: {
		devices: {
			name: string
			deviceId: string
			RSSI: number
	 ...
	 * @version 1.1.0
	 */
	export let onBluetoothAdapterStateChange:(call: (res: { available: boolean, discovering: boolean }) => void) => Promise<any>
	/**
	 * 根据 uuid 获取处于已连接状态的设备
	 * @version 1.1.0
	 */
	export let getConnectedBluetoothDevices:(params: { services: string[] }) => Promise<any>
	/**
	 * 获取在蓝牙模块生效期间所有已发现的蓝牙设备。包括已经和本机处于连接状态的设备
	 * @version 1.1.0
	 */
	export let getBluetoothDevices:() => Promise<any>
	/**
	 * 获取本机蓝牙适配器状态
	 * @version 1.1.0
	 */
	export let getBluetoothAdapterState:() => Promise<{
		discovering: boolean
		available: boolean
	}>
	/**
	 ...
	 * @version 1.1.0
	 */
	export let closeBluetoothAdapter:() => Promise<any>
	/**
	 ...
	 */
	export let getBatteryInfo:() => Promise<{
		level: string
		isCharging: boolean
	}>
	/**
	 ...
	 * @version 1.1.0
	 */
	export let setClipboardData:(params: { data: string }) => Promise<any>
	/**
	 * 获取系统剪贴板的内容
	 * @version 1.1.0
	 */
	export let getClipboardData:() => Promise<{data:string}>
	/**
	 * 关闭 NFC 模块。仅在安卓系统下有效
	 * @version 1.7.0
	 */
	export let stopHCE:() => Promise<any>
	/**
	 * 初始化 NFC 模块
	 * @version 1.7.0
	 */
	export let startHCE:(params: { aid_list: string[] }) => Promise<any>
	/**
	 * 发送 NFC 消息。仅在安卓系统下有效
	 * @version 1.7.0
	 */
	export let sendHCEMessage:(params: { data: ArrayBuffer }) => Promise<any>
	/**
	 * 监听接收 NFC 设备消息事件
	 * @version 1.7.0
	 */
	export let onHCEMessage:(call: (res: { messageType: number, data: ArrayBuffer, reason: number }) => void) => void
	/**
	 * 判断当前设备是否支持 HCE 能力
	 * @version 1.7.0
	 */
	export let getHCEState:() => Promise<any>
	/**
	 * 监听网络状态变化事件
	 * @version 1.1.0
	 */
	export let onNetworkStatusChange:(call: (res: { isConnected: boolean, networkType: string }) => void) => void
	/**
	 * 获取网络类型
	 */
	export let getNetworkType:() => Promise<{
		networkType: string
	}>
	/**
	 * 设置屏幕亮度
	 * @version 1.2.0
	 */
	export let setScreenBrightness:(params: { value: number }) => Promise<any>
	/**
	 * 设置是否保持常亮状态。仅在当前小程序生效，离开小程序后设置失效
	 * @version 1.4.0
	 */
	export let setKeepScreenOn:(params: { keepScreenOn: boolean }) => Promise<any>
	/**
	 * 监听用户主动截屏事件。用户使用系统截屏按键截屏时触发
	 * @version 1.4.0
	 */
	export let onUserCaptureScreen:(call: () => void) => void
	/**
	 * 获取屏幕亮度
	 * @version 1.2.0
	 */
	export let getScreenBrightness:(params: { position: number }) => Promise<{value:number}>
	/**
	 * 拨打电话
	 */
	export let makePhoneCall:(params: { phoneNumber: string }) => Promise<any>
	/**
	 * 停止监听加速度数据
	 * @version 1.1.0
	 */
	export let stopAccelerometer:() => Promise<any>
	/**
	 * 开始监听加速度数据
	 * @version 1.1.0
	 */
	export let startAccelerometer:(params?: { interval?: 'game'|'ui'|'normal' }) => Promise<any>
	/**
	 ...
	 * @version 1.1.0
	 */
	export let onAccelerometerChange:(call: (res: { x: number, y: number, z: number }) => void) => void
	/**
	 * 停止监听罗盘数据
	 * @version 1.1.0
	 */
	export let stopCompass:() => Promise<any>
	/**
	 * 开始监听罗盘数据
	 * @version 1.1.0
	 */
	export let startCompass:() => Promise<any>
	/**
	 * 监听罗盘数据变化事件。频率：5 次/秒，接口调用后会自动开始监听，可使用 wx.stopCompass 停止监听
	 * @version 1.1.0
	 */
	export let onCompassChange:(call: (res: {direction:number,accuracy:number|string}) => void) => void
	/**
	 * 停止监听设备方向的变化
	 * @version 2.3.0
	 */
	export let stopDeviceMotionListening:() => Promise<any>
	/**
	 * 开始监听设备方向的变化
	 * @version 2.3.0
	 */
	export let startDeviceMotionListening:(params?: { interval?: 'game'|'ui'|'normal' }) => Promise<any>
	/**
	 * 监听设备方向变化事件。频率根据 wx.startDeviceMotionListening() 的 interval 参数。可以使用 wx.stopDeviceMotionListening() 停止监听
	 * @version 2.3.0
	 */
	export let onDeviceMotionChange:(call: (res: { alpha: number, beta: number, gamma: number }) => void) => void
	/**
	 * 停止监听陀螺仪数据
	 * @version 2.3.0
	 */
	export let stopGyroscope:() => Promise<any>
	/**
	 * 开始监听陀螺仪数据
	 * @version 2.3.0
	 */
	export let startGyroscope:(params: { interval?: 'game'|'ui'|'normal' }) => Promise<any>
	/**
	 * 监听陀螺仪数据变化事件。频率根据 wx.startGyroscope() 的 interval 参数。可以使用 wx.stopGyroscope() 停止监听。
	 * @version 2.3.0
	 */
	export let onGyroscopeChange:(call: (res: { x: number, y: number, z: number }) => void) => void
	/**
	 * 监听内存不足告警事件
	 * 
	 ...
	 * @version 2.0.2
	 */
	export let onMemoryWarning:(call: (res: { level: number }) => void) => void
	/**
	 * 调起客户端扫码界面进行扫码
	 */
	export let scanCode:(params?: { onlyFromCamera?: boolean, scanType?: string[] }) => Promise<any>
	/**
	 * 使手机发生较短时间的振动（15 ms）。仅在 iPhone 7 / 7 Plus 以上及 Android 机型生效
	 * @version 1.2.0
	 */
	export let vibrateShort:() => Promise<any>
	/**
	 * 使手机发生较长时间的振动（400 ms)
	 * @version 1.2.0
	 */
	export let vibrateLong:() => Promise<any>
	/**
	 * 监听路由变动，在路由改变之前执行
	 */
	export let routerBefore:(call: (res: { form: string, to: string }) => any) => void
	/**
	 * 监听路由变动，在路由改变之后执行
	 */
	export let routerAfter:(call: (res: { form: string, to: string }) => any) => void
	// /**
	//  * @version 1.1.0
	//  */
	// export let seekBackgroundAudio:(params: { position: number }) => Promise<any>
