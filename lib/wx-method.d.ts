...
declare namespace tenp {
     ...
     * @version 1.1.1
     */
    const base64ToArrayBuffer: (base: string) => ArrayBuffer;
    /**
    ...
    const getSystemInfoSync: () => wx.SystemInfo;
    /**获取系统信息 */
    const getSystemInfo: () => Promise<wx.SystemInfo>;
    /**
     ...
     * @version 1.9.90
     */
    const getUpdateManager: () => wx.UpdateManager;
    /**
     ...
     * @version 2.1.2
     */
    const getLaunchOptionsSync: (call: (params: wx.AppOptions) => void) => void;
    /**
     * 监听小程序要打开的页面不存在事件
     *
     * @version 2.1.2
     */
    const onPageNotFound: (call: (params: {
        path: string;
        query: any;
        isEntryPage: boolean;
    }) => void) => void;
     ...
     * @version 2.1.2
     */
    const onError: (call: (error: any) => void) => void;
    /**
     * 监听音频中断结束事件。在收到 onAudioInterruptionBegin 事件之后，小程序内所有音频会暂停，收到此事件之后才可再次播放成功
     *
     * @version 2.6.2
     */
    const onAudioInterruptionEnd: (call: () => void) => void;
    /**
     * 监听音频因为受到系统占用而被中断开始事件。以下场景会触发此事件：闹钟、电话、FaceTime 通话、微信语音聊天、微信视频聊天。此事件触发后，小程序内所有音频会暂停。
     *
     * @version 2.6.2
     */
    const onAudioInterruptionBegin: (call: () => void) => void;
    /**
     * 监听小程序要打开的页面不存在事件
     *
     * @version 2.1.2
     */
    const onAppShow: (call: (params: {
        /** 小程序切前台的路径 */
        path: string;
        /** 小程序切前台的场景值 */
        scene: number;
     ...
     * @version 2.1.2
     */
    const onAppHide: (call: () => void) => void;
    /**
     * 取消监听小程序要打开的页面不存在事件
     *
     * @version 2.1.2
     */
    const offPageNotFound: (call: () => void) => void;
    /**
     * 取消监听小程序错误事件
     *
     * @version 2.1.2
     */
    const offError: (call: () => void) => void;
    /**
     * 取消监听音频中断结束事件
     *
     * @version 2.6.2
     */
    const offAudioInterruptionEnd: (call: () => void) => void;
    /**
     * 取消监听音频因为受到系统占用而被中断开始事件
     *
     * @version 2.6.2
     */
    const offAudioInterruptionBegin: (call: () => void) => void;
    /**
     * 取消监听小程序切前台事件
     *
     * @version 2.1.2
     */
    const offAppShow: (call: () => void) => void;
    /**
     * 取消监听小程序切后台事件
     *
     * @version 2.1.2
     */
    const offAppHide: (call: () => void) => void;
    /**
     * 设置是否打开调试开关。此开关对正式版也能生效
     *
     * @version 1.4.0
     */
    const setEnableDebug: (params: {
        enableDebug: boolean;
    }) => Promise<any>;
    /**
     * 获取日志管理器对象。
     ...
     * 隐藏 loading 提示框
     */
    const hideLoading: () => Promise<any>;
    /**
     * 隐藏消息提示框
     */
    const hideToast: () => Promise<any>;
    /**
     * 在当前页面显示导航条加载动画
     */
    const showNavigationBarLoading: () => Promise<any>;
    /**
     * 动态设置当前页面的标题
     */
     ...
     * @version 1.4.0
     */
    const setNavigationBarColor: (params: {
        frontColor: string;
     ...
     * 在当前页面隐藏导航条加载动画
     */
    const hideNavigationBarLoading: () => Promise<any>;
    /**
     * 动态设置下拉背景字体、loading 图的样式
     *
     * @version 2.1.0
     */
    const setBackgroundTextStyle: (params: {
     ...
     * @version 1.9.0
     */
    const removeTabBarBadge: (params: {
        index: number;
    }) => Promise<any>;
    /**
     ...
     * @version 1.5.0
     */
    const stopPullDownRefresh: () => Promise<any>;
    /**
     ...
     * @version 2.3.0
     */
    const offWindowResize: () => void;
    /**
     * 监听键盘高度变化
     *
     * @version 2.7.0
     */
    const onKeyboardHeightChange: (call: (res: {
        height: number;
    }) => void) => void;
    /**
     ...
     * @version 2.7.0
     */
    const getSelectedTextRange: (call: (res: any) => void) => void;
    /**
    ...
    /**异步获取当前storage的相关信息 */
    const getStorageInfo: () => Promise<wx.StorageInfo>;
    /**wx.getStorageInfo 的同步版本 */
    const getStorageInfoSync: () => wx.StorageInfo;
    /**
     * 创建 map 上下文 [MapContext](https://developers.weixin.qq.com/miniprogram/dev/api/media/map/MapContext.html) 对象。
     */
    const createMapContext: (mapId: string) => wx.MapContext;
    /**
     * 保存图片到系统相册
     *
     ...
     * @version 1.2.0
     */
    const saveImageToPhotosAlbum: (params: {
        filePath: string;
    }) => Promise<any>;
    /**
     ...
     * @version 2.5.0
     */
    const chooseMessageFile: (params: {
        count: number;
     ...
     * @version 1.2.0
     */
    const saveVideoToPhotosAlbum: (params: {
        filePath: string;
    }) => Promise<any>;
    /**
     ...
     *
     */
    const createVideoContext: (videoId: string) => wx.VideoContext;
    /**
     * 拍摄视频或从手机相册中选视频
     *
     */
     ...
     * @version 2.3.0
     */
    const setInnerAudioOption: (params?: {
     ...
     * 从基础库 1.6.0 开始，本接口停止维护，请使用 [wx.createInnerAudioContext](https://developers.weixin.qq.com/miniprogram/dev/api/media/audio/wx.createInnerAudioContext.html) 代替
     */
    const pauseVoice: () => Promise<any>;
    /**
     * 获取当前支持的音频输入源
     *
     * @version 2.1.0
     */
    const getAvailableAudioSources: () => Promise<any>;
    /**
     ...
     * @version 1.6.0
     */
    const createInnerAudioContext: () => wx.InnerAudioContext;
    /**
     * 创建 audio 上下文 [AudioContext](https://developers.weixin.qq.com/miniprogram/dev/api/media/audio/AudioContext.html) 对象
     *
     * 从基础库 1.6.0 开始，本接口停止维护，请使用 [wx.createInnerAudioContext](https://developers.weixin.qq.com/miniprogram/dev/api/media/audio/wx.createInnerAudioContext.html) 代替
     */
    const createAudioContext: (id: string, instance: any) => wx.AudioContext;
    /**
     * 停止播放音乐
     *
     ...
     */
    const stopBackgroundAudio: () => Promise<any>;
    /**
     * 控制音乐播放进度
     *
     * 从基础库 1.2.0 开始，本接口停止维护，请使用 [wx.getBackgroundAudioManager](https://developers.weixin.qq.com/miniprogram/dev/api/media/background-audio/wx.getBackgroundAudioManager.html) 代替
     */
    const seekBackgroundAudio: (params: {
        position: number;
    }) => Promise<any>;
    /**
     ...
     * 从基础库 1.2.0 开始，本接口停止维护，请使用 [wx.getBackgroundAudioManager](https://developers.weixin.qq.com/miniprogram/dev/api/media/background-audio/wx.getBackgroundAudioManager.html) 代替
     */
    const playBackgroundAudio: (params: {
        dataUrl: string;
        title?: string;
        coverImgUrl?: string;
    }) => Promise<any>;
     ...
     * 从基础库 1.2.0 开始，本接口停止维护，请使用 [wx.getBackgroundAudioManager](https://developers.weixin.qq.com/miniprogram/dev/api/media/background-audio/wx.getBackgroundAudioManager.html) 代替
     */
    const pauseBackgroundAudio: () => Promise<any>;
    /**
     * 监听音乐停止事件
     *
     * 从基础库 1.2.0 开始，本接口停止维护，请使用 [wx.getBackgroundAudioManager](https://developers.weixin.qq.com/miniprogram/dev/api/media/background-audio/wx.getBackgroundAudioManager.html) 代替
     */
    const onBackgroundAudioStop: (call: () => void) => void;
    /**
     * 监听音乐播放事件
     *
     * 从基础库 1.2.0 开始，本接口停止维护，请使用 [wx.getBackgroundAudioManager](https://developers.weixin.qq.com/miniprogram/dev/api/media/background-audio/wx.getBackgroundAudioManager.html) 代替
     */
    const onBackgroundAudioPlay: (call: () => void) => void;
    /**
     * 监听音乐暂停事件
     *
     * 从基础库 1.2.0 开始，本接口停止维护，请使用 [wx.getBackgroundAudioManager](https://developers.weixin.qq.com/miniprogram/dev/api/media/background-audio/wx.getBackgroundAudioManager.html) 代替
     */
    const onBackgroundAudioPause: (call: () => void) => void;
    /**
     * 获取后台音乐播放状态
     *
     * 从基础库 1.2.0 开始，本接口停止维护，请使用 [wx.getBackgroundAudioManager](https://developers.weixin.qq.com/miniprogram/dev/api/media/background-audio/wx.getBackgroundAudioManager.html) 代替
     */
    const getBackgroundAudioPlayerState: () => Promise<any>;
    /**
     ...
     * @version 1.2.0
     */
    const getBackgroundAudioManager: () => wx.BackgroundAudioManager;
     ...
     * @version 1.7.0
     */
    const createLivePusherContext: () => LivePusherContext;
    const createLivePlayerContext: (id: string, instance?: any) => wx.LivePlayerContext;
    /**
     * 停止录音
     *
    ...
    const getLocation: (params?: {
        type?: "wgs84" | "gcj02";
        altitude?: boolean;
    }) => Promise<wx.LocationData>;
    /**
     * 获取当前支持的音频输入源
     *
     */
    const chooseLocation: () => Promise<any>;
    /**
     * 更新转发属性
     *
     * @version 1.2.0
     */
    const updateShareMenu: (params?: {
    ...
    /**显示当前页面的转发按钮 */
    const showShareMenu: (params?: {
        withShareTicket?: boolean;
    }) => Promise<any>;
    /**隐藏转发按钮 */
    const hideShareMenu: () => Promise<any>;
    /**获取转发详细信息 */
     ...
     */
    const canvasPutImageData: (params: {
        canvasId: string;
     ...
     *
     */
    const getSavedFileList: () => Promise<wx.GetSavedFileListData>;
    /**
     ...
     *
     */
    const getSavedFileInfo: (params: {
        filePath: string;
    }) => Promise<wx.SavedFileInfoData>;
    /**
     * 获取全局唯一的文件管理器
     *
     * @version 1.9.9
     */
    const getFileSystemManager: () => wx.FileSystemManager;
    /**
     * 获取文件信息
     *
     * @version 1.4.0
     ...
     */
    const checkSession: () => Promise<any>;
    /**
     * 打开另一个小程序
     *
     * @version 1.3.0
     ...
     * @version 1.3.0
     */
    const navigateBackMiniProgram: (params?: {
        extraData?: any;
    }) => Promise<any>;
    /**
     * 获取当前帐号信息
     ...
     * @version 2.2.2
     */
    const getAccountInfoSync: (params: {
        tempFilePath: string;
    }) => wx.AccountInfo;
    /**
     * 获取用户信息
    ...
    const getUserInfo: (params?: {
        ...
        lang?: "en" | "zh_CN" | "zh_TW";
    }) => Promise<wx.UserInfoResponse>;
    /**
     * 自定义业务数据监控上报接口
     *
     * @version 2.0.1
     */
    const reportMonitor: (name: string, value: number) => void;
    /**
     * 自定义分析数据上报接口。使用前，需要在小程序管理后台自定义分析中新建事件，配置好事件名与字段
     */
    const reportAnalytics: (eventName: string, data: object) => void;
    /**
     ...
     */
    const openSetting: () => Promise<any>;
    /**
     * 获取用户的当前设置。返回值中只会出现小程序已经向用户请求过的权限
     *
     * @version 1.2.0
     */
    const getSetting: () => Promise<{
        authSetting: {
     ...
     * @version 1.5.0
     */
    const chooseInvoiceTitle: () => Promise<{
        type: string;
        title: string;
        taxNumber: string;
     ...
     * @version 1.5.0
     */
    const startSoterAuthentication: (params: {
     ...
     * @version 1.5.0
     */
    const checkIsSupportSoterAuthentication: () => Promise<{
     ...
     * @version 1.6.0
     */
    const checkIsSoterEnrolledInDevice: (params: {
     ...
     * @version 1.2.0
     */
    const stopBeaconDiscovery: () => Promise<any>;
    /**
     * 开始搜索附近的 iBeacon 设备
     *
     * @version 1.2.0
     */
    const startBeaconDiscovery: (params: {
        uuids: string[];
     ...
     * @version 1.2.0
     */
    const onBeaconUpdate: (call?: (beacons: wx.Beacon[]) => void) => void;
    /**
     * 监听 iBeacon 服务状态变化事件
     *
     * @version 1.2.0
     */
    const onBeaconServiceChange: (call?: (available: boolean, discovering: boolean) => void) => void;
    /**
     ...
     *
     */
    const getBeacons: () => Promise<wx.GetBeaconsSuccess>;
    /**
     * 关闭 Wi-Fi 模块
     *
     * @version 1.6.0
     */
    const stopWifi: () => Promise<any>;
    /**
     * 初始化 Wi-Fi 模块
     *
     * @version 1.6.0
     */
    const startWifi: () => Promise<any>;
    /**
     * 设置 wifiList 中 AP 的相关信息。在 onGetWifiList 回调后调用，iOS特有接口
     *
     * @version 1.6.0
     */
    const setWifiList: (params: {
     ...
     * @version 1.6.0
     */
    const onWifiConnected: (callback?: (wifi: wx.WiFi) => void) => void;
    /**
     * 监听获取到 Wi-Fi 列表数据事件
     *
     * @version 1.6.0
     */
    const onGetWifiList: (callback?: (res: wx.GetWifiListOptions) => void) => void;
    /**
     ...
     * @version 1.6.0
     */
    const getWifiList: () => Promise<any>;
    /**
     * 获取已连接中的 Wi-Fi 信息
     *
     * @version 1.6.0
     */
    const getConnectedWifi: () => Promise<wx.WiFi>;
    /**
     ...
     *
     */
    const readBLECharacteristicValue: (params: {
        deviceId: string;
        serviceId: string;
     ...
     * 监听低功耗蓝牙连接状态的改变事件。包括开发者主动连接或断开连接，设备丢失，连接异常断开等等
     */
    const onBLECharacteristicValueChange: (callback?: (res: {
        /**
     ...
     */
    const notifyBLECharacteristicValueChange: (params: {
        deviceId: string;
        serviceId: string;
        characteristicId: string;
        state: boolean;
     ...
     *
     */
    const getBLEDeviceServices: (params: {
        deviceId: string;
    }) => Promise<any>;
    /**
     ...
     *
     */
    const getBLEDeviceCharacteristics: (params: {
        deviceId: string;
        serviceId: string;
    }) => Promise<any>;
    /**
     ...
     */
    const createBLEConnection: (params: {
        deviceId: string;
        timeout?: number;
    }) => Promise<any>;
    /**
     ...
     *
     */
    const closeBLEConnection: (params: {
        deviceId: string;
    }) => Promise<any>;
    /**
     ...
     *
     */
    const writeBLECharacteristicValue: (params: {
        deviceId: string;
        serviceId: string;
        characteristicId: string;
        value: ArrayBuffer;
     ...
     *
     */
    const stopBluetoothDevicesDiscovery: () => Promise<any>;
    /**
     ...
     *
     */
    const startBluetoothDevicesDiscovery: (params: {
        services: string[];
    ...
    /**监听寻找到新设备的事件 */
    const onBluetoothDeviceFound: (callback?: (res: {
        devices: wx.BluetoothDevice[];
    }) => void) => void;
    /**监听蓝牙适配器状态变化事件 */
    const onBluetoothAdapterStateChange: (callback?: (res: wx.BluetoothAdapterState) => void) => void;
    /**
     * 根据 uuid 获取处于已连接状态的设备
     *
     */
    const getConnectedBluetoothDevices: (params: {
        services: string[];
    }) => Promise<{
        devices: wx.BluetoothDevice[];
    }>;
     ...
     *
     */
    const getBluetoothDevices: () => Promise<{
        devices: wx.BluetoothDevice[];
    }>;
    /**
     * 获取本机蓝牙适配器状态
     *
     */
    const getBluetoothAdapterState: () => Promise<wx.BluetoothAdapterStateData>;
    /**
     ...
     *
     */
    const closeBluetoothAdapter: () => Promise<any>;
     ...
     *
     */
    const getClipboardData: () => Promise<{
        data: string;
    }>;
    /**
     * 关闭 NFC 模块。仅在安卓系统下有效
     ...
     * @version 1.7.0
     */
    const stopHCE: () => Promise<any>;
    /**
     * 初始化 NFC 模块
     *
     * @version 1.7.0
     */
    const startHCE: (params: {
        aid_list: string[];
    }) => Promise<any>;
    /**
     * 发送 NFC 消息。仅在安卓系统下有效
     ...
     * @version 1.7.0
     */
    const getHCEState: () => Promise<any>;
    /**监听网络状态变化事件 */
    const onNetworkStatusChange: (callback: (res: {
        isConnected: boolean;
     ...
     *
     */
    const getNetworkType: () => Promise<wx.NetworkTypeData>;
    /**
     * 设置屏幕亮度
     *
     * @version 1.2.0
     */
    const setScreenBrightness: (params: {
        value: number;
    }) => Promise<any>;
    /**
     ...
     * @version 1.4.0
     */
    const onUserCaptureScreen: (callback?: (res: any) => void) => void;
    /**
     * 获取屏幕亮度
     *
     * @version 1.2.0
     */
    const getScreenBrightness: () => Promise<any>;
    /**
     * 拨打电话
     *
     */
    const makePhoneCall: (params: {
        phoneNumber: string;
    }) => Promise<any>;
    /**
     * 停止监听加速度数据
     *
     */
    const stopAccelerometer: () => Promise<any>;
    /**
     * 开始监听加速度数据
     *
     */
    const startAccelerometer: (params?: {
        interval?: string;
    }) => Promise<any>;
    /**
     ...
     */
    const onAccelerometerChange: (callback: wx.AccelerometerChangeCallback) => void;
    /**
     * 停止监听罗盘数据
     *
     */
    const stopCompass: () => Promise<any>;
    /**
     * 开始监听罗盘数据
     *
     */
    const startCompass: () => Promise<any>;
    /**监听罗盘数据变化事件。频率：5 次/秒，接口调用后会自动开始监听，可使用 wx.stopCompass 停止监听 */
    const onCompassChange: (callback: wx.CompassChangeCallback) => void;
    /**
     * 停止监听设备方向的变化
     *
     * @version 2.3.0
     */
    const stopDeviceMotionListening: () => Promise<any>;
    /**
     * 开始监听设备方向的变化
     *
     * @version 2.3.0
     */
    const startDeviceMotionListening: (params?: {
     ...
     * @version 2.3.0
     */
    const onDeviceMotionChange: (call: (res: {
        alpha: number;
        beta: number;
        gamma: number;
    }) => void) => void;
     ...
     * @version 2.3.0
     */
    const stopGyroscope: () => Promise<any>;
    /**
     * 开始监听陀螺仪数据
     *
     * @version 2.3.0
     */
    const startGyroscope: (params: {
        interval?: "normal" | "game" | "ui";
    }) => Promise<any>;
    /**
     ...
     * @version 2.3.0
     */
    const onGyroscopeChange: (callback: (res: {
        x: number;
        y: number;
        z: number;
    }) => void) => void;
     ...
     * @version 2.0.2
     */
    const onMemoryWarning: (callback: (res: {
        level: number;
    }) => void) => void;
    /**
     * 调起客户端扫码界面进行扫码
     ...
     * @version 1.2.0
     */
    const vibrateShort: () => Promise<any>;
    /**
     * 使手机发生较长时间的振动（400 ms)
     *
     * @version 1.2.0
     */
    const vibrateLong: () => Promise<any>;
    interface Worker {
        /**向主线程/Worker 线程发送的消息 */
     ...
     * @version 1.9.90
     */
    const createWorker: (scriptPath: string) => Worker;
    /**wx.getExtConfig 的同步版本 */
    const getExtConfigSync: () => wx.ExtConfig;
    /**
     * 获取第三方平台自定义的数据字段
     *
     */
    const getExtConfig: () => Promise<wx.ExtConfig>;
    /**
     * 返回一个 SelectorQuery 对象实例。在自定义组件或包含自定义组件的页面中，应使用 this.createSelectorQuery() 来代替
     *
     * @version 1.4.0
     */
    const createSelectorQuery: () => wx.SelectorQuery;
    /**
     * 创建并返回一个 IntersectionObserver 对象实例。在自定义组件或包含自定义组件的页面中，应使用 this.createIntersectionObserver([options]) 来代替
     *
     * @version 1.9.3
     */
    const createIntersectionObserver: (context: wx.Component<any, any, []>, options?: wx.CreateIntersectionObserverOption) => wx.IntersectionObserver;
    /**
     ...
     * @version 2.0.4
     */
    const createRewardedVideoAd: (adUnitId: any) => any;
    /**
     ...
     * @version 2.6.0
     */
    const createInterstitialAd: (adUnitId: any) => any;
}
export default tenp;
